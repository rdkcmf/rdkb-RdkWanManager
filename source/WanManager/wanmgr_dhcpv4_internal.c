...
ANSC_STATUS WanMgr_Dhcpv4RegSetDhcpv4Info ( ANSC_HANDLE hThisObject )
{
    ...
    while ( pSLinkEntry )
    {
        ...
        _ansc_sprintf(FolderName, "%u", pDhcpcContext->InstanceNumber);
        ...
        while ( pSLinkEntry2 )
        {
            ...
            _ansc_sprintf(FolderName, "%u", pDhcpcReqOptionContext->InstanceNumber);
...
SentOption:
        ...
        while ( pSLinkEntry2 )
        {
            ...
            _ansc_sprintf(FolderName, "%u", pDhcpcSendOptionContext->InstanceNumber);
